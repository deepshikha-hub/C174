...
btn_doctor = Button(root, text="Show the hospital alloted", command=obj1.getDoctor,bg="#1763A5", fg="white",relief = FLAT)

btn_doctor.place(relx=0.1, rely=0.23,anchor=CENTER)
btn_it = Button(root, text="Show the IT company alloted", command=obj2.getIT,bg="#1763A5", fg="white",relief = FLAT)

btn_it.place(relx=0.11, rely=0.53,anchor=CENTER)
btn_chemical = Button(root, text="Show the chemical company alloted", command=obj3.getChemical, bg="#1763A5", fg="white",relief = FLAT)
